...
class _MainScreenState extends State<_MainScreen> {
  ...
  String dynamicLinkDataVar = 'NO-LINK';
  @override
  void initState() {
    super.initState();
    initDynamicLinks();
  ...
  Future<void> initDynamicLinks() async {
    dynamicLinks.onLink.listen((dynamicLinkData) {
      setState(() {
        dynamicLinkDataVar = dynamicLinkData.toString();
      });
    }).onError((error) {
      print('onLink error');
      print(error.message);
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      socialMetaTagParameters: SocialMetaTagParameters(
        ...
        imageUrl: Uri(
          path:
              'https://s2.abcstatics.com/media/estilo/2017/02/08/cara-kjo--1190x800@abc.jpg',
        ),
        title: 'TITULO',
      ),
    );
